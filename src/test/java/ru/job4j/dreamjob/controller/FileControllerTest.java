...
class FileControllerTest {
    ...
    @Test
    public void whenRequestFileByIdThenGetFileContent() throws IOException {
    ...
    @Test
    public void whenRequestNonExistentFileByIdThenGetNotFoundStatus() throws IOException {
